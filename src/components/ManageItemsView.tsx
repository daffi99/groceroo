...
export const ManageItemsView: React.FC<ManageItemsViewProps> = ({
  ...
  return (
    <div className="w-full max-w-md mx-auto px-3.5 py-3 pb-24 overflow-x-hidden">
      {/* Top Title & Add Button */}
      <div className="bg-white rounded-2xl sm:rounded-3xl p-3.5 sm:p-4 border border-slate-200/80 shadow-xs mb-3">
        <div className="flex items-center justify-between gap-2 mb-3">
          ...
          <button
            ...
            className="shrink-0 flex items-center gap-1.5 px-3 py-1.5 sm:px-3.5 sm:py-2 rounded-xl bg-emerald-600 active:bg-emerald-700 text-white font-bold text-xs shadow-sm shadow-emerald-600/30 transition"
          >
            ...
            >
              ...
              <div className="flex-1 min-w-0 pr-1">
                ...
                <div className="flex items-center gap-1.5 mt-0.5 flex-wrap">
                  {cat && (
                    <span
                      className={`text-[9.5px] font-semibold px-1.5 py-0.5 rounded-md flex items-center gap-1 shrink-0 ${cat.bgColor} ${cat.textColor}`}
                    >
              ...
              <div className="flex items-center gap-1 shrink-0">
                <button
                  ...
                  className="w-7 h-7 sm:w-8 sm:h-8 rounded-xl bg-slate-100 hover:bg-emerald-50 hover:text-emerald-700 text-slate-600 flex items-center justify-center transition active:scale-95"
                  title="Edit Barang"
                >
                ...
                <button
                  ...
                  className="w-7 h-7 sm:w-8 sm:h-8 rounded-xl bg-slate-100 hover:bg-rose-50 hover:text-rose-600 text-slate-400 flex items-center justify-center transition active:scale-95"
                  title="Hapus Barang"
                >
